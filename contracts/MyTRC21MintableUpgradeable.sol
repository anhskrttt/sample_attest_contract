...
abstract contract MinterRoleUpgradeable {
	...
	function __MinterRoleUpgradeable_init() internal {
...
contract MyTRC21MintableUpgradeable is TRC21, MinterRoleUpgradeable, Initializable {
    string private _name;
    string private _symbol;
    uint8 private _decimals;

    function __TRC21_init(string memory name_, string memory symbol_, uint8 decimals_, uint256 cap, uint256 minFee
    ) initializer internal {
        __MinterRoleUpgradeable_init();
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
